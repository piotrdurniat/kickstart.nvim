  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      vim.keymap.set({ 'x', 'o' }, 'aa', function()
        select_to.select_textobject('@parameter.outer', 'textobjects')
      end, { desc = 'Select around a parameter/argument' })
      vim.keymap.set({ 'x', 'o' }, 'ia', function()
        select_to.select_textobject('@parameter.inner', 'textobjects')
      end, { desc = 'Select inner part of a parameter/argument' })

      -- Move to the next/previous text object start/end
      ...
      vim.keymap.set({ 'n', 'x', 'o' }, ']C', function()
        move_to.goto_next_end('@class.outer', 'textobjects')
      end)
      vim.keymap.set({ 'n', 'x', 'o' }, '[f', function()
        move_to.goto_previous_start('@function.outer', 'textobjects')
      end)
      vim.keymap.set({ 'n', 'x', 'o' }, '[c', function()
        move_to.goto_previous_start('@class.outer', 'textobjects')
      end)
      vim.keymap.set({ 'n', 'x', 'o' }, '[F', function()
        move_to.goto_previous_end('@function.outer', 'textobjects')
      end)
      vim.keymap.set({ 'n', 'x', 'o' }, '[C', function()
        move_to.goto_previous_end('@class.outer', 'textobjects')
      end)
